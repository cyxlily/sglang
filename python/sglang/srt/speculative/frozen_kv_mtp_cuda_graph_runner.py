...
class FrozenKVMTPCudaGraphRunner(DecodeCudaGraphRunner):
    ...
    def capture_one_shape(
        ...
        request_bs = size
        expanded_bs = request_bs * self.req_token_width
    ...
    def execute(self, forward_batch: ForwardBatch):
        ...
        raw_bs = (
            raw_expanded_bs // self.req_token_width
            if self.topk > 1
